...
import { validateRequest, studentCreateSchema, studentUpdateSchema } from '../middleware/validation.js';
 ...
 */
router.post('/', authenticateToken, authorizeOperator, validateRequest(studentCreateSchema), StudentController.createStudent);
 ...
 */
router.put('/:id', authenticateToken, authorizeOperator, validateRequest(studentUpdateSchema), StudentController.updateStudent);
